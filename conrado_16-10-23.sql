...
-- Dumping data for table eztrack.datos_pagos: ~6 rows (approximately)
REPLACE INTO `datos_pagos` (`id`, `direccion`, `estado`, `dni`, `email`, `titular`, `banco`, `createdAt`, `deletedAt`, `updatedAt`) VALUES
	(3, 'qwe 333', 'santa feee', 12312333, 'asd3@gmail.com', 'enrique lopezzz', 'banco galicia', '2023-10-09 03:40:12', NULL, '2023-10-16 19:09:08'),
	(4, 'QWE 123', 'cordoba', 12345678, 'lopez@gmail.com', 'ENRIQUE LOPEZ URRUCHAGA', '1234567812345678', '2023-10-10 21:04:42', NULL, '2023-10-10 21:04:42'),
	(5, 'QWE 123', 'cordoba', 12345678, 'lopez@gmail.com', 'ENRIQUE LOPEZ URRUCHAGA', '1234567812345678', '2023-10-10 21:05:11', NULL, '2023-10-10 21:05:11'),
	(6, 'QWE 123', 'cordoba', 12345678, 'lopez@gmail.com', 'ENRIQUE LOPEZ URRUCHAGA', '1234567812345678', '2023-10-10 21:06:03', NULL, '2023-10-10 21:06:03'),
	(7, 'qwe 123', NULL, 12451245, 'ejemplar@gmail.com', 'ENRIQUE LOPEZ ', 'banco macro', '2023-10-16 19:10:54', NULL, '2023-10-16 19:10:54'),
	(8, 'asd 123', 'cordoba', 12452356, 'luis@gmail.com', 'LUIS ORTEGA', 'banco patagonia', '2023-10-16 19:13:21', NULL, '2023-10-16 19:13:21');
...
REPLACE INTO `pagos_pendientes` (`id`, `total`, `idUsuario`, `metodo`, `createdAt`, `deletedAt`, `updatedAt`, `status`, `idReserva`, `archivo`, `idDatosPago`) VALUES
	...
	(11, 80, 1, NULL, '2023-10-16 19:10:54', NULL, '2023-10-16 19:10:54', 'pendiente', 51, NULL, 7),
	(12, 40, 1, NULL, '2023-10-16 19:13:21', NULL, '2023-10-16 19:13:21', 'pendiente', 52, NULL, 8);
...
REPLACE INTO `reservas` (`id`, `idUsuario`, `idVehiculo`, `idEvento`, `idOpcionAlquiler`, `subtotal`, `idPago`, `fecha`, `createdAt`, `updatedAt`, `deletedAt`, `status`) VALUES
	...
	(51, 1, 1, 1, 34, NULL, NULL, '2023-09-05', '2023-10-16 19:09:20', '2023-10-16 19:09:26', NULL, NULL),
	(52, 1, 1, 2, 35, NULL, NULL, '2023-09-14', '2023-10-16 19:12:43', '2023-10-16 19:12:50', NULL, NULL);
