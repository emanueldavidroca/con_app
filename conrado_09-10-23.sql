...
-- Dumping data for table eztrack.datos_pagos: ~1 rows (approximately)
...
-- Dumping data for table eztrack.opcion_alquileres: ~16 rows (approximately)
...
REPLACE INTO `pagos_pendientes` (`id`, `total`, `idUsuario`, `metodo`, `createdAt`, `deletedAt`, `updatedAt`, `status`, `idReserva`) VALUES
	(1, 25000, 1, 'transferencia bancaria', '2023-10-06 16:39:50', NULL, '2023-10-06 16:39:53', 'pendiente', 25);
...
-- Dumping data for table eztrack.reservas: ~7 rows (approximately)
