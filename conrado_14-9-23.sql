...
REPLACE INTO `eventos` (`id`, `nombre`, `ciudad`, `nombre_evento`, `nombre_autodromo`, `url_ubicacion`, `fecha_desde`, `fecha_hasta`, `createdAt`, `updatedAt`, `deletedAt`) VALUES
	(1, 'redbull', 'palermo', 'epic winter', 'C1', 'www.url.com', '2023-09-03', '2023-09-03', NULL, NULL, NULL),
...
-- Dumping data for table eztrack.reservas: ~9 rows (approximately)
...
-- Dumping data for table eztrack.vehiculos: ~3 rows (approximately)
