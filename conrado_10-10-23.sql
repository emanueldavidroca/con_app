...
-- Dumping data for table eztrack.opcion_alquileres: ~26 rows (approximately)
...
-- Dumping data for table eztrack.pagos_pendientes: ~3 rows (approximately)
...
-- Dumping data for table eztrack.reservas: ~18 rows (approximately)
