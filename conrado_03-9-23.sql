...
-- Dumping database structure for conrado_admin
CREATE DATABASE IF NOT EXISTS `conrado_admin` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `conrado_admin`;

-- Dumping structure for table conrado_admin.eventos
...
-- Dumping data for table conrado_admin.eventos: ~0 rows (approximately)

-- Dumping structure for table conrado_admin.eventos_lista
...
-- Dumping data for table conrado_admin.eventos_lista: ~0 rows (approximately)

-- Dumping structure for table conrado_admin.metodo_pago
...
-- Dumping data for table conrado_admin.metodo_pago: ~0 rows (approximately)

-- Dumping structure for table conrado_admin.opcion_alquiler
...
-- Dumping data for table conrado_admin.opcion_alquiler: ~0 rows (approximately)

-- Dumping structure for table conrado_admin.pagos
...
-- Dumping data for table conrado_admin.pagos: ~0 rows (approximately)

-- Dumping structure for table conrado_admin.reservas
...
-- Dumping data for table conrado_admin.reservas: ~0 rows (approximately)

-- Dumping structure for table conrado_admin.usuarios
...
-- Dumping data for table conrado_admin.usuarios: ~2 rows (approximately)
...
-- Dumping structure for table conrado_admin.vehiculos
...
-- Dumping data for table conrado_admin.vehiculos: ~1 rows (approximately)
